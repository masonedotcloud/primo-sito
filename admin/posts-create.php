                    ...
                    <form action="posts-create.php" method="post" enctype="multipart/form-data">
                    	<div class="form-row">
                    		<div class="col">
                    			<div class="mb-5">
                                        <label>Title</label>
                                        <input type="text" class="form-control border text-primary" name="title" value="<?php echo $title ?>">
                                   </div>
                                   <div class="mb-5">
                         			<label>Body</label>
                    		...
                    		<div class="mb-5">
                                   <label>Topic</label>
                    			<select name="topic_id" class="form-select border text-primary" aria-label="Default select example">
                    				<option value=""></option>
                    			...
                    			<?php if (empty($published)): ?>
                    				<label>
                    					<div class="form-check form-switch">
                    						<input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="published">
                    						Publish
                                             </div>
                                        </label>
                    			<?php else: ?>
                    				<label>
                    					<div class="form-check form-switch">
                    						<input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="published" checked>
                                             </div>
                                             Publish
                    				</label>
                    			<?php endif; ?>
                    		...
                    		<div class="mb-5">
                    			<button type="submit" name="add-post" class="btn btn-warning">Add Post</button>
                    		</div>
                    	</div>
                    </form>
               </div>
