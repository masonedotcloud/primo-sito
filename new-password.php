          ...
          <div class="contianer mt-5">
               <div class="row d-flex justify-content-center m-0">
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm col form login-form">
                         <form action="new-password.php" method="POST" autocomplete="" class="d-flex flex-column p-4 rounded-3">
                              ...
                              <div class="form-group mb-3 d-flex justify-content-center">
                                   <input class="form-control border text-primary" type="password" name="password" placeholder="Create new password" required>
                              </div>
                              <div class="form-group mb-3 d-flex justify-content-center">
                                   <input class="form-control border text-primary" type="password" name="cpassword" placeholder="Confirm your password" required>
                              </div>
                              <div class="d-flex justify-content-center form-group mb-3">
                                   <input class="form-control btn-success" type="submit" name="change-password" value="Change">
                              </div>
                         </form>
                    </div>
               </div>
